        ...
        if ($__R.mode || !$__R.mode && target === 8) loop_continue0: {
            ...
            if ($__R.mode && k in O || !$__R.mode && target === 8) {
                ...
                try {
                    ...
                    } else if (target === 8) app4 = $__R.stack[$__R.stack.length - 1].f();
                } catch (exn1) {
                    if (exn1 instanceof $__T.Capture) {
                        ...
                        $__R.pushTrace("Line 48: in array_map");
                    }
        ...
        if ($__R.mode || !$__R.mode && (target === 13 || target === 12)) loop_continue1: {
            if ($__R.mode && i in t || !$__R.mode && (target === 13 || target === 12)) {
                ...
                try {
                    ...
                    } else if (target === 12) app7 = $__R.stack[$__R.stack.length - 1].f();
                } catch (exn2) {
                    if (exn2 instanceof $__T.Capture) {
                        ...
                        $__R.pushTrace("Line 92: in array_filter");
                    }
                ...
                if ($__R.mode && app7 || !$__R.mode && target === 13) {
                    try {
                        if ($__R.mode) {
                            app8 = res.push(val);
                        } else if (target === 13) app8 = $__R.stack[$__R.stack.length - 1].f();
                    } catch (exn3) {
                        if (exn3 instanceof $__T.Capture) {
                            ...
                            $__R.pushTrace("Line 93: in array_filter");
                        }
...
if ($__R.mode) array_sort.box = function fun023(o, comparator) {
    ...
    if ($__R.mode) {
            ...
            if ($__R.mode || !$__R.mode && (target === 16 || target === 15)) loop_break2: while ($__R.mode && i < length || !$__R.mode && (target === 16 || target === 15)) {
                if ($__R.mode || !$__R.mode && (target === 16 || target === 15)) loop_continue2: {
                    try {
                        ...
                        } else if (target === 15) aCharCode = $__R.stack[$__R.stack.length - 1].f();
                    } catch (exn4) {
                        if (exn4 instanceof $__T.Capture) {
                            ...
                            $__R.pushTrace("Line 111: in stringComparator");
                        }
                    ...
                    try {
                        ...
                        } else if (target === 16) bCharCode = $__R.stack[$__R.stack.length - 1].f();
                    } catch (exn5) {
                        if (exn5 instanceof $__T.Capture) {
                            ...
                            $__R.pushTrace("Line 112: in stringComparator");
                        }
                ...
                if ($__R.mode || !$__R.mode && target === 23) loop_continue11: {
                    if ($__R.mode && right < rightEnd || !$__R.mode && target === 23) {
                        ...
                        try {
                            ...
                            } else if (target === 23) comparisonResult00 = $__R.stack[$__R.stack.length - 1].f();
                        } catch (exn6) {
                            if (exn6 instanceof $__T.Capture) {
                                ...
                                $__R.pushTrace("Line 199: in merge");
                            }
                ...
                if ($__R.mode || !$__R.mode && target === 24) loop_continue12: {
                    ...
                    if ($__R.mode || !$__R.mode && target === 24) loop_break14: while ($__R.mode && srcIndex < valueCount || !$__R.mode && target === 24) {
                        if ($__R.mode || !$__R.mode && target === 24) loop_continue14: {
                            try {
                                if ($__R.mode) {
                                    app9 = merge.box(dst, src, srcIndex, valueCount, width, comparator);
                                } else if (target === 24) app9 = $__R.stack[$__R.stack.length - 1].f();
                            } catch (exn7) {
                                if (exn7 instanceof $__T.Capture) {
                                    ...
                                    $__R.pushTrace("Line 215: in mergeSort");
                                }
        ...
        bucketSort.box = function fun020(array, dst, bucket, depth) {
            ...
            if ($__R.mode && (bucket.length < 32 || depth > 32) || !$__R.mode && target === 25) {
                try {
                    if ($__R.mode) {
                        app10 = mergeSort.box(bucket, bucket.length, stringComparator.box);
                    } else if (target === 25) app10 = $__R.stack[$__R.stack.length - 1].f();
                } catch (exn8) {
                    if (exn8 instanceof $__T.Capture) {
                        ...
                        $__R.pushTrace("Line 229: in bucketSort");
                    }
            ...
            if ($__R.mode || !$__R.mode && target === 26) loop_break16: while ($__R.mode && i < bucket.length || !$__R.mode && target === 26) {
                if ($__R.mode || !$__R.mode && target === 26) loop_continue16: {
                    ...
                    try {
                        ...
                        } else if (target === 26) c = $__R.stack[$__R.stack.length - 1].f();
                    } catch (exn9) {
                        if (exn9 instanceof $__T.Capture) {
                            ...
                            $__R.pushTrace("Line 243: in bucketSort");
                        }
            ...
            if ($__R.mode || !$__R.mode && target === 27) loop_break17: while ($__R.mode && i < buckets.length || !$__R.mode && target === 27) {
                if ($__R.mode || !$__R.mode && target === 27) loop_continue17: {
                    ...
                    try {
                        if ($__R.mode) {
                            app11 = bucketSort.box(array, dst, buckets[i], depth + 1);
                        } else if (target === 27) app11 = $__R.stack[$__R.stack.length - 1].f();
                    } catch (exn10) {
                        if (exn10 instanceof $__T.Capture) {
                            ...
                            $__R.pushTrace("Line 253: in bucketSort");
                        }
        ...
        comparatorSort.box = function fun021(array, length, comparator) {
            ...
            try {
                ...
                } else if (target === 28) valueCount = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn11) {
                if (exn11 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 258: in comparatorSort");
                }
            ...
            try {
                if ($__R.mode) {
                    app12 = mergeSort.box(array, valueCount, comparator);
                } else if (target === 29) app12 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn12) {
                if (exn12 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 259: in comparatorSort");
                }
        ...
        stringSort.box = function fun022(array, length) {
            ...
            try {
                if ($__R.mode) {
                    valueCount = compact.box(array, length);
                } else if (target === 30) valueCount = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn13) {
                if (exn13 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 262: in stringSort");
                }
            ...
            try {
                if ($__R.mode) {
                    app13 = bucketSort.box(array, 0, strings, 0);
                } else if (target === 32) app13 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn14) {
                if (exn14 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 267: in stringSort");
                }
    ...
    if ($__R.mode && typeof comparator === "function" || !$__R.mode && target === 33) {
        try {
            if ($__R.mode) {
                app14 = comparatorSort.box(array, length, comparator);
            } else if (target === 33) app14 = $__R.stack[$__R.stack.length - 1].f();
        } catch (exn15) {
            if (exn15 instanceof $__T.Capture) {
                ...
                $__R.pushTrace("Line 277: in array_sort");
            }
        ...
        if ($__R.mode && (comparator === null || comparator === undefined) || !$__R.mode && target === 34) {
            try {
                if ($__R.mode) {
                    app15 = stringSort.box(array, length);
                } else if (target === 34) app15 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn16) {
                if (exn16 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 280: in array_sort");
                }
...
if ($__R.mode) stopifyArray.box = function fun026(arr) {
    ...
    try {
        if ($__R.mode) {
            app17 = Reflect.setPrototypeOf(arr, stopifyArrayPrototype.box);
        } else if (target === 40) app17 = $__R.stack[$__R.stack.length - 1].f();
    } catch (exn17) {
        if (exn17 instanceof $__T.Capture) {
            ...
            $__R.pushTrace("Line 393: in stopifyArray");
        }
...
if ($__R.mode) fun00 = function funExpr0(f) {
    ...
    try {
        ...
        } else if (target === 42) arg00 = $__R.stack[$__R.stack.length - 1].f();
    } catch (exn18) {
        if (exn18 instanceof $__T.Capture) {
            ...
            $__R.pushTrace("Line 307: in (anonymous function)");
        }
...
if ($__R.mode) fun01 = function funExpr1(f) {
    ...
    try {
        ...
        } else if (target === 44) arg01 = $__R.stack[$__R.stack.length - 1].f();
    } catch (exn19) {
        if (exn19 instanceof $__T.Capture) {
            ...
            $__R.pushTrace("Line 308: in (anonymous function)");
        }
...
if ($__R.mode) fun02 = function funExpr2(f, init) {
    ...
    if ($__R.mode || !$__R.mode && target === 46) loop_break19: while ($__R.mode && i >= 0 || !$__R.mode && target === 46) {
        if ($__R.mode || !$__R.mode && target === 46) loop_continue19: {
            try {
                if ($__R.mode) {
                    app18 = f(acc, this[i], i, this);
                } else if (target === 46) app18 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn20) {
                if (exn20 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 316: in (anonymous function)");
                }
...
if ($__R.mode) fun03 = function funExpr3(f, init) {
    ...
    if ($__R.mode || !$__R.mode && target === 47) loop_break20: while ($__R.mode && i < bound || !$__R.mode && target === 47) {
        if ($__R.mode || !$__R.mode && target === 47) loop_continue20: {
            try {
                if ($__R.mode) {
                    app19 = f(acc, this[i], i, this);
                } else if (target === 47) app19 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn21) {
                if (exn21 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 329: in (anonymous function)");
                }
    ...
    if ($__R.mode || !$__R.mode && target === 48) loop_break21: while ($__R.mode && i < l || !$__R.mode && target === 48) {
        if ($__R.mode || !$__R.mode && target === 48) loop_continue21: {
            try {
                if ($__R.mode) {
                    app20 = pred(this[i]);
                } else if (target === 48) app20 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn22) {
                if (exn22 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 339: in (anonymous function)");
                }
    ...
    if ($__R.mode || !$__R.mode && target === 49) loop_break22: while ($__R.mode && i < l || !$__R.mode && target === 49) {
        if ($__R.mode || !$__R.mode && target === 49) loop_continue22: {
            try {
                if ($__R.mode) {
                    app21 = pred(this[i]);
                } else if (target === 49) app21 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn23) {
                if (exn23 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 350: in (anonymous function)");
                }
    ...
    if ($__R.mode || !$__R.mode && target === 50) loop_break23: while ($__R.mode && i < l || !$__R.mode && target === 50) {
        if ($__R.mode || !$__R.mode && target === 50) loop_continue23: {
            try {
                if ($__R.mode) {
                    app22 = pred(this[i]);
                } else if (target === 50) app22 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn24) {
                if (exn24 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 361: in (anonymous function)");
                }
    ...
    if ($__R.mode || !$__R.mode && target === 51) loop_break24: while ($__R.mode && i < l || !$__R.mode && target === 51) {
        if ($__R.mode || !$__R.mode && target === 51) loop_continue24: {
            try {
                if ($__R.mode) {
                    app23 = pred(this[i]);
                } else if (target === 51) app23 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn25) {
                if (exn25 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 371: in (anonymous function)");
                }
...
if ($__R.mode) fun08 = function method0(f) {
    ...
    if ($__R.mode || !$__R.mode && target === 52) loop_break25: while ($__R.mode && i < l || !$__R.mode && target === 52) {
        if ($__R.mode || !$__R.mode && target === 52) loop_continue25: {
            try {
                if ($__R.mode) {
                    app24 = f(this[i], i, this);
                } else if (target === 52) app24 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn26) {
                if (exn26 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 383: in method0");
                }
...
if ($__R.mode) fun09 = function funExpr8(comparator) {
    ...
    try {
        ...
        } else if (target === 53) arg02 = $__R.stack[$__R.stack.length - 1].f();
    } catch (exn27) {
        if (exn27 instanceof $__T.Capture) {
            ...
            $__R.pushTrace("Line 388: in (anonymous function)");
        }
