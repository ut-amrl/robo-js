...
if ($__R.mode) handleNew.box = function fun12(constr, ...args) {
    ...
    if ($__R.mode || target === 3) {
        if ($__R.mode) result00 = constr.apply(obj00, args);else if (target === 3) result00 = $__R.stack[$__R.stack.length - 1].f();

        if (result00 instanceof $__T.Capture) {
            result00.stack.push({
                kind: "rest",
                f: restoreNextFrame,
                index: 3,
            ...
            captureLocals(result00.stack[result00.stack.length - 1]);
            return result00;
        }
    }
...
if ($__R.mode) array_sort.box = function fun23(o, comparator) {
    ...
    if ($__R.mode) {
        ...
        stringComparator.box = function fun14(a, b) {
            ...
            if ($__R.mode || !$__R.mode && (target === 6 || target === 5)) loop_break0: while ($__R.mode && i < length || !$__R.mode && (target === 6 || target === 5)) {
                if ($__R.mode || !$__R.mode && (target === 6 || target === 5)) loop_continue0: {
                    if ($__R.mode || target === 5) {
                        if ($__R.mode) aCharCode = aString.charCodeAt(i);else if (target === 5) aCharCode = $__R.stack[$__R.stack.length - 1].f();
                    ...
                    if ($__R.mode || target === 6) {
                        if ($__R.mode) bCharCode = bString.charCodeAt(i);else if (target === 6) bCharCode = $__R.stack[$__R.stack.length - 1].f();
                ...
                if ($__R.mode || !$__R.mode && target === 13) loop_continue9: {
                    if ($__R.mode && right < rightEnd || !$__R.mode && target === 13) {
                        ...
                        if ($__R.mode || target === 13) {
                            if ($__R.mode) comparisonResult00 = comparator(src[right], src[left]);else if (target === 13) comparisonResult00 = $__R.stack[$__R.stack.length - 1].f();
                ...
                if ($__R.mode || !$__R.mode && target === 14) loop_continue10: {
                    ...
                    if ($__R.mode || !$__R.mode && target === 14) loop_break12: while ($__R.mode && srcIndex < valueCount || !$__R.mode && target === 14) {
                        if ($__R.mode || !$__R.mode && target === 14) loop_continue12: {
                            if ($__R.mode || target === 14) {
                                if ($__R.mode) app2 = merge.box(dst, src, srcIndex, valueCount, width, comparator);else if (target === 14) app2 = $__R.stack[$__R.stack.length - 1].f();

                                if (app2 instanceof $__T.Capture) {
                                    app2.stack.push({
                                        kind: "rest",
                                        f: restoreNextFrame,
                                        index: 14,
                                    ...
                                    captureLocals(app2.stack[app2.stack.length - 1]);
                                    return app2;
                                }
                            }
                        }
        ...
        bucketSort.box = function fun20(array, dst, bucket, depth) {
            ...
            if ($__R.mode && (bucket.length < 32 || depth > 32) || !$__R.mode && target === 15) {
                if ($__R.mode || target === 15) {
                    if ($__R.mode) app3 = mergeSort.box(bucket, bucket.length, stringComparator.box);else if (target === 15) app3 = $__R.stack[$__R.stack.length - 1].f();

                    if (app3 instanceof $__T.Capture) {
                        app3.stack.push({
                            kind: "rest",
                            f: restoreNextFrame,
                            index: 15,
                        ...
                        captureLocals(app3.stack[app3.stack.length - 1]);
                        return app3;
                    }
                }
            ...
            if ($__R.mode || !$__R.mode && target === 16) loop_break14: while ($__R.mode && i < bucket.length || !$__R.mode && target === 16) {
                if ($__R.mode || !$__R.mode && target === 16) loop_continue14: {
                    ...
                    if ($__R.mode || target === 16) {
                        if ($__R.mode) c = string.charCodeAt(depth);else if (target === 16) c = $__R.stack[$__R.stack.length - 1].f();
            ...
            if ($__R.mode || !$__R.mode && target === 17) loop_break15: while ($__R.mode && i < buckets.length || !$__R.mode && target === 17) {
                if ($__R.mode || !$__R.mode && target === 17) loop_continue15: {
                    ...
                    if ($__R.mode || target === 17) {
                        if ($__R.mode) app4 = bucketSort.box(array, dst, buckets[i], depth + 1);else if (target === 17) app4 = $__R.stack[$__R.stack.length - 1].f();
        ...
        comparatorSort.box = function fun21(array, length, comparator) {
            ...
            if ($__R.mode || target === 18) {
                if ($__R.mode) valueCount = compact.box(array, length);else if (target === 18) valueCount = $__R.stack[$__R.stack.length - 1].f();
            ...
            if ($__R.mode || target === 19) {
                if ($__R.mode) app5 = mergeSort.box(array, valueCount, comparator);else if (target === 19) app5 = $__R.stack[$__R.stack.length - 1].f();

                if (app5 instanceof $__T.Capture) {
                    app5.stack.push({
                        kind: "rest",
                        f: restoreNextFrame,
                        index: 19,
                    ...
                    captureLocals(app5.stack[app5.stack.length - 1]);
                    return app5;
                }
            }
        ...
        stringSort.box = function fun22(array, length) {
            ...
            if ($__R.mode || target === 20) {
                if ($__R.mode) valueCount = compact.box(array, length);else if (target === 20) valueCount = $__R.stack[$__R.stack.length - 1].f();
            ...
            if ($__R.mode || target === 22) {
                if ($__R.mode) app6 = bucketSort.box(array, 0, strings, 0);else if (target === 22) app6 = $__R.stack[$__R.stack.length - 1].f();

                if (app6 instanceof $__T.Capture) {
                    app6.stack.push({
                        kind: "rest",
                        f: restoreNextFrame,
                        index: 22,
                    ...
                    captureLocals(app6.stack[app6.stack.length - 1]);
                    return app6;
                }
            }
    ...
    if ($__R.mode && typeof comparator === "function" || !$__R.mode && target === 23) {
        if ($__R.mode || target === 23) {
            if ($__R.mode) app7 = comparatorSort.box(array, length, comparator);else if (target === 23) app7 = $__R.stack[$__R.stack.length - 1].f();
        ...
        if ($__R.mode && (comparator === null || comparator === undefined) || !$__R.mode && target === 24) {
            if ($__R.mode || target === 24) {
                if ($__R.mode) app8 = stringSort.box(array, length);else if (target === 24) app8 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) stopifyArray.box = function fun24(arr) {
    ...
    if ($__R.mode || target === 26) {
        if ($__R.mode) app10 = Reflect.setPrototypeOf(arr, stopifyArrayPrototype.box);else if (target === 26) app10 = $__R.stack[$__R.stack.length - 1].f();
    ...
    if ($__R.mode || !$__R.mode && (target === 30 || target === 29)) loop_break17: while ($__R.mode && i01 < this.length || !$__R.mode && (target === 30 || target === 29)) {
        if ($__R.mode || !$__R.mode && (target === 30 || target === 29)) loop_continue17: {
            if ($__R.mode || target === 29) {
                if ($__R.mode) arg00 = f(this[i01]);else if (target === 29) arg00 = $__R.stack[$__R.stack.length - 1].f();
            ...
            if ($__R.mode || target === 30) {
                if ($__R.mode) app11 = result01.push(arg00);else if (target === 30) app11 = $__R.stack[$__R.stack.length - 1].f();
    ...
    if ($__R.mode || !$__R.mode && (target === 34 || target === 33)) loop_break18: while ($__R.mode && i02 < this.length || !$__R.mode && (target === 34 || target === 33)) {
        if ($__R.mode || !$__R.mode && (target === 34 || target === 33)) loop_continue18: {
            if ($__R.mode || target === 33) {
                if ($__R.mode) app12 = f(this[i02]);else if (target === 33) app12 = $__R.stack[$__R.stack.length - 1].f();
            ...
            if ($__R.mode && app12 || !$__R.mode && target === 34) {
                if ($__R.mode || target === 34) {
                    if ($__R.mode) app13 = result02.push(this[i02]);else if (target === 34) app13 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun2 = function funExpr2(f, init) {
    ...
    if ($__R.mode || !$__R.mode && target === 37) loop_break19: while ($__R.mode && i >= 0 || !$__R.mode && target === 37) {
        if ($__R.mode || !$__R.mode && target === 37) loop_continue19: {
            if ($__R.mode || target === 37) {
                if ($__R.mode) app14 = f(acc, this[i]);else if (target === 37) app14 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun3 = function funExpr3(f, init) {
    ...
    if ($__R.mode || !$__R.mode && target === 39) loop_break20: while ($__R.mode && i < arrLen || !$__R.mode && target === 39) {
        if ($__R.mode || !$__R.mode && target === 39) loop_continue20: {
            if ($__R.mode || target === 39) {
                if ($__R.mode) app15 = f(acc, this[i]);else if (target === 39) app15 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun4 = function funExpr4(pred) {
    ...
    if ($__R.mode || !$__R.mode && target === 41) loop_break21: while ($__R.mode && i < l || !$__R.mode && target === 41) {
        if ($__R.mode || !$__R.mode && target === 41) loop_continue21: {
            if ($__R.mode || target === 41) {
                if ($__R.mode) app16 = pred(this[i]);else if (target === 41) app16 = $__R.stack[$__R.stack.length - 1].f();

                if (app16 instanceof $__T.Capture) {
                    app16.stack.push({
                        kind: "rest",
                        f: restoreNextFrame,
                        index: 41,
                    ...
                    captureLocals(app16.stack[app16.stack.length - 1]);
                    return app16;
                }
            }
...
if ($__R.mode) fun5 = function funExpr5(pred) {
    ...
    if ($__R.mode || !$__R.mode && target === 43) loop_break22: while ($__R.mode && i < l || !$__R.mode && target === 43) {
        if ($__R.mode || !$__R.mode && target === 43) loop_continue22: {
            if ($__R.mode || target === 43) {
                if ($__R.mode) app17 = pred(this[i]);else if (target === 43) app17 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun6 = function funExpr6(pred) {
    ...
    if ($__R.mode || !$__R.mode && target === 45) loop_break23: while ($__R.mode && i < l || !$__R.mode && target === 45) {
        if ($__R.mode || !$__R.mode && target === 45) loop_continue23: {
            if ($__R.mode || target === 45) {
                if ($__R.mode) app18 = pred(this[i]);else if (target === 45) app18 = $__R.stack[$__R.stack.length - 1].f();
    ...
    if ($__R.mode || !$__R.mode && target === 47) loop_break24: while ($__R.mode && i < l || !$__R.mode && target === 47) {
        if ($__R.mode || !$__R.mode && target === 47) loop_continue24: {
            if ($__R.mode || target === 47) {
                if ($__R.mode) app19 = pred(this[i]);else if (target === 47) app19 = $__R.stack[$__R.stack.length - 1].f();
    ...
    if ($__R.mode || !$__R.mode && target === 49) loop_break25: while ($__R.mode && i < l || !$__R.mode && target === 49) {
        if ($__R.mode || !$__R.mode && target === 49) loop_continue25: {
            if ($__R.mode || target === 49) {
                if ($__R.mode) app20 = f(this[i]);else if (target === 49) app20 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun9 = function funExpr8(comparator) {
    ...
    if ($__R.mode || target === 51) {
        if ($__R.mode) arg01 = array_sort.box(this, comparator);else if (target === 51) arg01 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun10 = function funExpr9(begin, end) {
    ...
    if ($__R.mode || target === 55) {
        if ($__R.mode) arg02 = Array.prototype.slice.call(this, begin, end);else if (target === 55) arg02 = $__R.stack[$__R.stack.length - 1].f();
...
if ($__R.mode) fun11 = function funExpr10(anotherArray) {
    ...
    if ($__R.mode || target === 58) {
        if ($__R.mode) arg03 = Array.prototype.concat.call(this, anotherArray);else if (target === 58) arg03 = $__R.stack[$__R.stack.length - 1].f();

        if (arg03 instanceof $__T.Capture) {
            arg03.stack.push({
                kind: "rest",
                f: restoreNextFrame,
                index: 58,
            ...
            captureLocals(arg03.stack[arg03.stack.length - 1]);
            return arg03;
        }
    }
