    ...
    if ($__R.mode) {
        ...
        toPrimitive.box = function fun1(x) {
            ...
            if ($__R.mode && typeof x === 'object' && x !== 'null' || !$__R.mode && (target === 5 || target === 4)) {
                try {
                    if ($__R.mode) {
                        v00 = x.valueOf();
                    } else if (target === 4) v00 = $__R.stack[$__R.stack.length - 1].f();
                } catch (exn1) {
                    if (exn1 instanceof $__T.Capture) {
                        ...
                        $__R.pushTrace("Line 6: in toPrimitive");
                    }
                ...
                if ($__R.mode && typeof v00 === 'object' && v00 !== 'null' || !$__R.mode && target === 5) {
                    try {
                        if ($__R.mode) {
                            app2 = x.toString();
                        } else if (target === 5) app2 = $__R.stack[$__R.stack.length - 1].f();
                    } catch (exn2) {
                        if (exn2 instanceof $__T.Capture) {
                            ...
                            $__R.pushTrace("Line 8: in toPrimitive");
                        }
        ...
        toKey.box = function fun2(x) {
            ...
            try {
                ...
                } else if (target === 6) r00 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn3) {
                if (exn3 instanceof $__T.Capture) {
                    ...
                    $__R.pushTrace("Line 19: in toKey");
                }
        ...
        add.box = function fun3(x, y) {
            ...
            try {
                ...
                } else if (target === 8) app3 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn4) {
            ...
            try {
                ...
                } else if (target === 9) app4 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn5) {
        ...
        mul.box = function fun4(x, y) {
            ...
            try {
                ...
                } else if (target === 10) app5 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn6) {
            ...
            try {
                ...
                } else if (target === 11) app6 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn7) {
        ...
        div.box = function fun6(x, y) {
            ...
            try {
                ...
                } else if (target === 14) app9 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn10) {
            ...
            try {
                ...
                } else if (target === 15) app10 = $__R.stack[$__R.stack.length - 1].f();
            } catch (exn11) {
